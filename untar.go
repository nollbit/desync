...
func UnTar(ctx context.Context, r io.Reader, fs UntarFilesystem, opts UntarOptions) error {
...
func UnTarIndex(ctx context.Context, fs UntarFilesystem, index Index, s Store, n int, opts UntarOptions, pb ProgressBar) error {
